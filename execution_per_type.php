 ...
 */
    ...
    class execution_per_typePage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Execution Per Account Type');
            $this->SetMenuLabel('Execution PerAccount Type');
    
            $selectQuery = 'select distinct brokerid, analysisdate, type, 
            ...
            $this->dataset = new QueryDataset(
              ...
              $selectQuery, $insertQuery, $updateQuery, $deleteQuery, 'execution_per_type');
        ...
        {
            $chart = new Chart('executionbytype', Chart::TYPE_COLUMN, $this->dataset);
            $chart->setTitle('');
            $chart->setHeight(488);
            $chart->setDomainColumn('type', 'Account Type', 'string');
        ...
        function partition_OnGetPartitions(&$partitions)
        {
            $brokerId = GetApplication()->GetSessionVariable('brokerId');
              ...
              $this->GetConnection()->ExecQueryToArray("
                  ...
                  from tlb_broker_report_overall
        ...
        protected function CreateGrid()
        {
            ...
            $defaultSortedColumns[] = new SortColumn('type', 'ASC');
        ...
        {
            if ($chart->getId() === 'executionbytype') {
    ...
    try
    {
        $Page = new execution_per_typePage("execution_per_type", "execution_per_type.php", GetCurrentUserPermissionsForPage("execution_per_type"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("execution_per_type"));
